...
banChats = false;
LolApi = "Xinnbotz" //Ganti sama Api
target = `${control.NomorOwner}16084013060@s.whatsapp.net`//Ganti jadi nomor lu
//=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×=×
...
//=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×=×
	   ...
	   let fkontak = { key: {participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: `6283136505591-1614953337@g.us` } : {}) }, message: { 'contactMessage': { 'displayName': `@XinnChan`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;@XinnChan,;;;\nFN:@XinnChan,\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': fs.readFileSync(`./gambar/thumb.jpg`), thumbnail: fs.readFileSync(`./gambar/thumb.jpg`),sendEphemeral: true}}}
...
//=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×=×
        let reply1 = (teks) => {
			deff.sendMessage(from, teks, text, { thumbnail: Rfake, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jmn} - ${week} ${weton} - ${calender}`,body:"DON'T CLICK HERE",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/p/16084013060`}}})
		}
//=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×=×
		let reply = (teks) => {
...
if (isGroupAdmins) return reply("Admin mah bebas ye kan😎");
		...
		deff.sendMessage(`16084013060@s.whatsapp.net`, `wa.me/${sender.split("@")[0]}\n telah mengirim Virtex ❗`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "BOT WHATSAPP",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./gambar/thumb.jpg'),sourceUrl:"https://wa.me/16084013060"}}})            
        }, 7000)
        setTimeout( () => {
        deff.sendMessage(from, '_1 Detik lagi..._', text, {quoted: fkontak})
        }, 6000)
...
if (!isUser) return sendButMessage(from, a, b, ton,{quoted : freply}) 
      ...
      deff.sendMessage(`16084013060@s.whatsapp.net`,`*Request :* ${v}`, text) //Jangan diubah bang
      break
//=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×=×
case 'request':
if (!isUser) return sendButMessage(from, a, b, ton,{quoted : freply}) 
...
if (!isUser) return sendButMessage(from, a, b, ton,{quoted : freply}) 
      ...
      deff.sendMessage('16084013060@s.whatsapp.net',`*Bug Report:* ${v}`, text) //jangan diubah ya adik²
      break
//=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×=×𝘤
...
if (!isUser) return sendButMessage(from, a, b, ton,{quoted : freply}) 
              ...
              buffer = await getBuffer(`https://api.lolhuman.xyz/api/rank?apikey=XinnChan&img=${profilePic}&background=https://i.ibb.co/8B6Q84n/LTqHsfYS.jpg&username=${pushname}&level=${userLevel}&ranking=${Number(userRank)}&currxp=${userXp}&xpneed=${requiredXp}`)
...
║╠ #kenji (No tujuan|Isi Surat)
║╠ Contoh: 
║╠ #kenji 628xxxxxxxxxx|Hai Juga
║╚▸
╚═══ ◤ *${NamaBot}* ◢ `
...
//=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×=×			
case 'sc': case 'script':
reply('https://youtube.com/channel/XinnChan') //Kalo punya otak jangan diubah ya adik²
break
//=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×=×			
...
vcard3 = 'BEGIN:VCARD\n' +
            ...
            'END:VCARD'.trim()
deff.sendMessage(from, {displayName: `KENJI`, vcard: vcard3}, contact,) 
     break
...
if (!isUser) return sendButMessage(from, a, b, ton,{quoted : freply}) 
        ...
        buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              ...
              contentText:`Follow ig owner @xinnchan795`,buttons,headerType:4}
...
case 'bcall': 
					...
					kpd = await deff.chats.all()
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						const encmedia = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo : mek
						buff = await deff.downloadMediaMessage(encmedia)
						for (let _ of kpd) {
							deff.sendMessage(_.jid, buff, image, {caption: `[ Broadcast ]\n\n${body.slice(4)}`})
						}
						reply('Suksess broadcast')
					} else {
						for (let _ of kpd) {
...
case 'broadcast3':
            ...
            if (args.length < 1) return reply('teks?')
             ...
             for (let _ of anu) {
             deff.sendMessage(_.jid, { contentText: `*🔖 BROADCAST [ • BOTWEA • ] 🔖*\n\n${body.slice(4)}`, footerText: '©𝑷𝒐𝒘𝒆𝒓𝒆𝒅_𝑩𝒚|•𝑿𝒆𝒏𝒏', buttons: [{ buttonId: `${prefix}command`, buttonText: { displayText: 'MENU' }, type: 1 }, { buttonId: `${prefix}owner`, buttonText: { displayText: 'OWNER' }, type: 1 }], headerType: 6, locationMessage: { degreesLatitude: 0, degreesLongitude: 0, jpegThumbnail: bc2 }}, 'buttonsMessage')
}
             reply('Suksess broadcast')
}
break
case "kontag":
        ...
        break;
        case 'buttonpdf':
deff.sendMessage(from, {"contentText": 'Xenji Was Here broo' ,"footerText": virtex9(prefix) , "buttons": [
...
wa.me/16084013060`
sendButMessage(from, anjeng, `Baca rulesnya!, Jangan di baca doang, Patuhi juga blog❗`, [
{
buttonId: `${prefix} xin`,
buttonText: {
displayText: `💾MENU `,
